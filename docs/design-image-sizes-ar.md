...
| شبكة Bento للتصنيفات (ديسكتوب) | WooCommerce | خلايا أحجام متعدّدة — **مربع أو أفقي** مع **منطقة آمنة وسطية** | `object-cover` + `sizes` ≈ **50vw** / **28vw**. [`home-category-bento.tsx`](../features/home/components/home-category-bento.tsx). |
