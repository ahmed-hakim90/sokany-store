    ...
    >
      <Drawer.Portal>
        ...
        <Drawer.Content
          ...
          className={cn(
            "fixed bottom-2 left-2 top-2 z-[100] flex h-[calc(100%-1rem)] max-h-[calc(100dvh-1rem)]  max-w-md flex-col rounded-2xl border border-border/80 bg-page outline-none",
          )}
        >
